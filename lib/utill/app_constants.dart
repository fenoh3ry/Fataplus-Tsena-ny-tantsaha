...
class AppConstants {
  static const String appName = 'Fataplus-Tsena';
  static const double appVersion = 1.0;
  static const AppMode appMode = AppMode.release;
  static const String fontFamily = 'Poppins';
  static const String baseUrl = 'https://admin.fata.plus';
  ...
  static const String topic = 'fataplus';
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(imageUrl: Images.franceFlag, languageName: 'Français', countryCode: 'FR', languageCode: 'fr'),
  ];
